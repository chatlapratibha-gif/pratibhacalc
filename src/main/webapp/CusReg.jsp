...
<div class="formdata">
<form:form onsubmit="return validate()" action="cusreg" modelAttribute="cus" method="post">
<!-- First Name, Last Name, Age, Gender, Contact Number, Address,City,State,Zipcode,emp Id, Password -->
<table>
<tr>
<td>FirstName:</td>
...
<tr>
<td>UserId:</td>
<td><form:input path="cusId" id="cusId" /></td>
</tr>
<tr>
<td>Password</td>
...
Already having account?<a href="cuslogin">Login</a>
<br>
<br>
${message}
</body>
